...
| Spend caps and reset audit trail | PASS (source/CI); BLOCKED (packaged mutation) | Atomic budget, daily/monthly caps, reset adjustments, crash recovery, and authorization suites pass in CI. | User could not edit daily or monthly amounts in the final packaged wizard; diagnose issue #14 and retest. |
